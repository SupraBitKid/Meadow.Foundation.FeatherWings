...
The **CharlieWing** library is included in the **Meadow.Foundation.FeatherWings.CharlieWing** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.FeatherWings.CharlieWing`
## Usage
